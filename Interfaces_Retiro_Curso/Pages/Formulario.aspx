...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <form runat="server">
        ...
        <br />
            ...
            <asp:Button runat="server" ID="btnSubir_Archivo" CssClass="btn-small btn-rounded" Text="Subir Archivo" OnClick="btnSubir_Archivo_Click" BackColor="Gray" ForeColor="White" />
            <asp:Button runat="server" ID="Enviar" CssClass="btn-small btn-rounded" Text="Enviar" OnClick="Enviar_Click" BackColor="Gray" ForeColor="White" />
        </div>
    </form>
